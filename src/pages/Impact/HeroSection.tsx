...
const HeroSection = () => (
  <section className="relative pt-24 pb-16 bg-gradient-to-br from-green-50 to-amber-50 overflow-hidden">
    ...
    <img
      src="/lovable-uploads/impact-hero.jpeg"
      alt="Impact Hero"
      className="absolute inset-0 w-full h-full object-cover z-0 animate-hero-bg"
      style={{
        objectFit: "cover",
        objectPosition: "center",
        filter: "blur(4px) brightness(0.6)", // Darkened the image slightly more
    ...
    <div className="container mx-auto px-4 relative z-20">
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          Transforming lives, empowering communities, and building a sustainable
          future for coconut farming in Karnataka.
        </p>
        {/* Subtle highlight behind text for extra pop */}
        <div
