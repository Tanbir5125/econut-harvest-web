const ProductsHeroSection = () => (
  <section className="relative pt-24 pb-16 bg-gradient-to-br from-green-50 to-amber-50 overflow-hidden">
    ...
    <img
      src="/lovable-uploads/prod-hero.jpeg"
    ...
    <div className="container mx-auto px-4 relative z-20">
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          Discover our complete range of authentic coconut products, sourced
          directly from Karnataka's finest organic farms and processed with
          traditional methods.
        </p>
