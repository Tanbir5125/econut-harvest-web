      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">Fresh Worth</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/fresh-worth" className="text-green-100 hover:text-white transition-colors">Fresh Worth</a></li>
          ...
          <div>
            ...
            <div className="flex space-x-2">
              <Input placeholder="Your email" className="bg-green-800 border-green-700 text-white placeholder:text-green-200" />
